...
map.getView().fit([538367.973044, 5674643.044106, 772748.521988, 5838828.181492], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">TOTEM AIRES DE SERVICE VIARHONA</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_TOTEMSAIRESDESERVICES_4,
    colName: 'Identifian',
    zoom: 10,
    collapsed: true,
    map: map,
