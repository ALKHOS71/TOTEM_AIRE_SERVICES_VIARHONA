...
var format_TOTEMSAIRESDESERVICES_4 = new ol.format.GeoJSON();
var features_TOTEMSAIRESDESERVICES_4 = format_TOTEMSAIRESDESERVICES_4.readFeatures(json_TOTEMSAIRESDESERVICES_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TOTEMSAIRESDESERVICES_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TOTEMSAIRESDESERVICES_4.addFeatures(features_TOTEMSAIRESDESERVICES_4);
var lyr_TOTEMSAIRESDESERVICES_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TOTEMSAIRESDESERVICES_4, 
                style: style_TOTEMSAIRESDESERVICES_4,
                popuplayertitle: 'TOTEMS AIRES DE SERVICES',
                interactive: true,
                title: '<img src="styles/legend/TOTEMSAIRESDESERVICES_4.png" /> TOTEMS AIRES DE SERVICES'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_EPCI_1.setVisible(false);lyr_COMMUNES_2.setVisible(false);lyr_VIARHONA_3.setVisible(true);lyr_TOTEMSAIRESDESERVICES_4.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_EPCI_1,lyr_COMMUNES_2,lyr_VIARHONA_3,lyr_TOTEMSAIRESDESERVICES_4];
...
lyr_TOTEMSAIRESDESERVICES_4.set('fieldAliases', {'Identifian': 'Identifian', 'Départeme': 'Départeme', 'EPCI_impla': 'EPCI_impla', 'Commune_im': 'Commune_im', });
...
lyr_TOTEMSAIRESDESERVICES_4.set('fieldImages', {'Identifian': 'TextEdit', 'Départeme': 'TextEdit', 'EPCI_impla': 'TextEdit', 'Commune_im': 'TextEdit', });
...
lyr_TOTEMSAIRESDESERVICES_4.set('fieldLabels', {'Identifian': 'inline label - always visible', 'Départeme': 'inline label - always visible', 'EPCI_impla': 'inline label - always visible', 'Commune_im': 'inline label - always visible', });
lyr_TOTEMSAIRESDESERVICES_4.on('precompose', function(evt) {
